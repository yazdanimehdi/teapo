            ...
            <v-row justify="end" align="start" style="padding: 0">
              ...
              <v-col cols="2" md="2" lg="2" sm="2" style="padding: 0">
                <v-img src="../../../assets/nextd.png" contain
                       max-height="60px" min-height="40px" v-if="writingMode === 'reviewMode'"></v-img>
                <v-img src="../../../assets/next.png" @click="dialog = true" contain
        ...
        <v-container fluid style="margin: 0; padding:0">
          <v-row justify="end" align="start">
            ...
            <v-col sm="4" lg="2" md="3" style="padding: 0; max-width: 250px">
              ...
              <span class='time'
                    v-if="this.time_component.enable">{{ formattedHours }} : {{ formattedMinutes }} : {{ formattedSeconds }}</span>
            </v-col>
          </v-row>
        </v-container>
      </v-row>
    ...
    <v-container fluid>
      <v-row style="width: 100%; margin: 0; padding: 5px">
        <div class="directions" style="width: 100%">
          <div style="width: 100%">Directions: You have {{ initialMinute }} minutes to plan and write your
            response. Your response will be judged on the basis of quality of your writing and on how well
            your response presents the points in the lecture and their relationship to the reading passage.
      ...
      <v-row>
        <v-col>
          <div class="right" :style="{'height': `${this.windowSize.height - 260}px`}">
          ...
          <v-container fluid class="writing" style="padding: 0; margin: 0">
            ...
            <v-row justify="center" align="start">
                            <textarea id="input" class="input" v-model="wordString"
                                      :disabled="writingMode === 'reviewMode'"
    ...
    <div class="text-xs-center">
      <v-dialog
        ...
        <v-card>
          ...
          <v-card-text>
            You still have time left for your writing do you want to finish the test?
          </v-card-text>
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      writings: state => state.writing.writing
    })
  },
  methods: {
    endTPO() {
