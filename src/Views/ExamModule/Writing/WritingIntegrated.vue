                                ...
                                <v-row align="start" justify="start">
                                    <v-col cols="6" sm="6" lg="6" md="6" xl="6" style="padding: 0; margin: 0">
                                        <v-row align="start" justify="start" style="padding: 0; margin: 0">
                                            <v-col cols="2" sm="2" lg="2" md="2" xl="2"
                                                   style="padding: 0; margin: 0; margin-bottom: 10px; padding-right: 4px">
                                                <img class="btn_writing" src="../../../assets/paste.png"
                                                     @click="triggerPaste">
                                            </v-col>
                                            <v-col cols="2" sm="2" lg="2" md="2" xl="2" style="padding: 0; margin: 0; padding-left: 20px">
