          ...
          <div class="direction" v-if="state === 1">
            ...
            <div style="margin: 5%; margin-top: 3%">
              <p>This section measures your ability to understand conversations and lectures in English.
                ...
                part
                you will listen to {{ conversationCount }} conversation and {{ lectureCount }} lectures. You will hear
              ...
              <p>For each part of the listening section you will have <span
                  style="font-weight: bold">{{ initialMinute }}</span> minutes to answer the
                questions.</p>
