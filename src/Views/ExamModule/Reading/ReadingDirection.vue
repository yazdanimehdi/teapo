          ...
          <div class="direction">
            ...
            <div style="margin: 5%; margin-top: 3%">
              <p>This section measures your ability to understand academic passages in English. You will
                ...
                top of the screen will display the starting time as <span
                    style="font-weight: bold">{{ initialHours | formatTime }} : {{ initialMinute | formatTime }} : {{ initialSeconds | formatTime }}</span>
